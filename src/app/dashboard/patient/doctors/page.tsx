...
export default function DoctorsPage({ patientId }: DoctorsPageProps) {
  ...
  const handleAssignDoctor = async (doctorId: string) => {
    ...
    try {
      const response = await assignDoctorToPatient(doctorId, patientId);
        console.log("Doctor assigned:", response);
        toast.success("Doctor assigned successfully");
    } catch (error) {
      const errorMessage = error instanceof Error ? error.message : "An error occurred while assigning the doctor";
